...
public class DeleteEmployeesServlet extends javax.servlet.http.HttpServlet{
    @Override
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException {
        ...
        Integer value = Integer.valueOf((request.getParameter("deleteemployee")));
        statement.executeUpdate("delete from employees where id = '" + value + "'");
